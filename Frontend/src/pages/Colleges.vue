...
const loadData = async () => {
  await store.fetchColleges(fetchParams.value)
}
...
<template>
  ...
  <div class="mt-10 overflow-x-auto rounded-box bg-transparent">
    ...
    <div v-else class="max-w-6xl mx-auto overflow-hidden rounded-xl shadow-md border border-gray-200 bg-white">
      <table class="table w-full">
        ...
        <tbody class="divide-y divide-gray-100">
          <tr v-for="c in store.colleges" :key="c.college_code" class="hover:bg-gray-50 transition-colors">
